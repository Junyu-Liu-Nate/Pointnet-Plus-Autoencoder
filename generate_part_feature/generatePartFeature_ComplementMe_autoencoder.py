...
def main():
    modelPath = 'log/reconstruction/ComplementMe_all_fps2048_corrected/checkpoints/best_model.pth'
    print("Model loaded.")
    ...
    dataType = "part_all_fps2048"
    pcDataPath = os.path.join(dataset, datasetType, category, dataType)

    #%%
    saveFolderName = "part_all_fps2048_autoencoder_corrected"
