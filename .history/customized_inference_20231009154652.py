...
def main():
    ...
    mesh_paths = []
    pcList = []
    for meshMame in meshNames:
        meshPath = os.path.join(meshDatasetFolder, meshName, "models", "model_normalized.obj")
        mesh_paths.append(meshPath)
    ...
    featureDataPath = "/Users/liujunyu/Data/Research/BVC/ITSS/" + "pointnet2_airplane_ShapeNetv2.txt"
