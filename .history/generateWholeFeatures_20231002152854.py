...
from fileIO import savePCAsObj, saveTensorAsNp
...
def computeWholeFeature(model, wholeVertices, numParts, minPoints = 1024):
    ...
    for idx in range(numParts):
        ...
        # visualizeFolder = "/Users/liujunyu/Data/Research/BVC/ITSS/visualize/pointnetParts/"
...
def main():
    ...
    for i in range(len(meshPaths)):
        ...
        savePath = os.path.join(outputPath, str(i) + "txt")
        saveTensorAsNp(wholeFeature, savePath)

        print(f"Finish generating whole feature for ")
