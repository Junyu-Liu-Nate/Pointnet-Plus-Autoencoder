...
def main():
    ...
    dataPath = os.path.join(dataset, datasetType, category, dataType)

    instanceNames = [d for d in os.listdir(meshDatasetFolder) if os.path.isdir(os.path.join(meshDatasetFolder, d))]