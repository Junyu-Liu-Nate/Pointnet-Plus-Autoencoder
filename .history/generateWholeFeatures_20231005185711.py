...
def main():
    ...
    pcDatasetPath = "/Users/liujunyu/Data/Research/BVC/ITSS/dataset/ModelNet40/airplane/train/"
    pcPaths = []
    for pcIdx in range(285, 601):
        pcPath = os.path.join(pcDatasetPath, 'airplane_' + f"{meshName:04d}" + '.off')
