...
def computeWholeFeature(wholeIdx, model, wholeVertices, numParts, minPoints = 1024, outputName):
    """
...
def main():
    ...
    for i in range(len(meshPaths)):
        ...
        numParts = 200
        wholeFeature = computeWholeFeature(i, model, wholeVertices, numParts, 1024, outputName)
