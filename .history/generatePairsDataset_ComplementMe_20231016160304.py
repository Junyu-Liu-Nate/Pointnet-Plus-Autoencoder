...
from fileIO import read_features_from_txt_shapenet, readSelectedMD5s_component, readSelectedMD5s_c, add_pair_to_existing_txt
...
def generatePairsDataset(outputPath):
    ...
    for idx in range(len(datasetTypes)):
        ...
        selectedNamePath = os.path.join(BASE_DATA_PATH, "dataset", "ComplementMe", datasetTypes[idx], "Airplane", "component_all_md5s.txt")
...
def main():
    ...
    outputName = "pairs_ComplementMe_airplane_exact_100_oct"
