...
def generatePairsDataset(outputPath):
    ...
    existNames = [d for d in os.listdir(dataset) if os.path.isdir(os.path.join(dataset, category, d))]
    for selectedWholeName in 
...
def main():
    ...
    outputName = "pairs_airplane_SHRED_exact_oct_train"
