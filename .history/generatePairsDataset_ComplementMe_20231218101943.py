...
def generatePairsDataset(outputPath):
    ...
    for idx in range(len(datasetTypes)):
        ...
        selectedNamePath = os.path.join(DATASET_PATH, "ComplementMe", datasetTypes[idx], "Airplane", "part_all_names.txt")
        selectedWholeNames = readSelectedMD5s_part(selectedNamePath)
...
def main():
    ...
    outputName = "pairs_airplane_ComplementMe_exact_oct_train_normalize"
