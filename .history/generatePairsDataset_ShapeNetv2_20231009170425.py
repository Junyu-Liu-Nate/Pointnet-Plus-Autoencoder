...
###     -  "Pointnet_Wholes_enlarged200/" whole features contain 200 parts.
def generatePairsDataset(outputPath):
    datasetFolder = "/Users/liujunyu/Data/Research/BVC/ITSS/dataset/"
    shapenetWholeFolder = "ShapeNetv2_Wholes_200"
    meshDatasetFolder = os.path.join(BASE_DATA_PATH, "dataset", "ShapeNetCore_v2", "02691156")
    meshNames = [d for d in os.listdir(meshDatasetFolder) if os.path.isdir(os.path.join(meshDatasetFolder, d))]
...
def main():
    datasetFolder = "/Users/liujunyu/Data/Research/BVC/ITSS/dataset/"
    outputName = "pairs_ShapeNetv2_airplane_exact_200"
