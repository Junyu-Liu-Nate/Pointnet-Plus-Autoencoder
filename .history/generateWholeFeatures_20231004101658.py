...
def computeWholeFeature(wholeIdx, model, wholeVertices, numParts, minPoints = 1024):
    """
    ...
    for idx in range(numParts):
        ...
        visualizeBaseFolder = "/Users/liujunyu/Data/Research/BVC/ITSS/visualize/Pointnet_Whole_test/"
        visualizeFolder = os.path.join(str(wholeIdx))
...
def main():
    ...
    outputName = "Pointnet_Wholes_test"
    objectName = "airplane"
    ...
    for i in range(len(meshPaths)):
        ...
        numParts = 50
        wholeFeature = computeWholeFeature(i, model, wholeVertices, numParts, 1024)
