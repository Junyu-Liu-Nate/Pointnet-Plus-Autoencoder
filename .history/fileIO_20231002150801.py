...
def save_point_cloud_as_obj(vertices: np.ndarray, file_path: str):
    """
    Saves a numpy array of vertices as a .obj file.
    
    :param vertices: A numpy array of shape (n, 3), where n is the number of vertices.
