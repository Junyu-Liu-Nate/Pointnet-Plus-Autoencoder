...
# from generate_pair_dataset.generateWholeFeatures_ModelNet40 import computeWholeFeature
...
def generatePairsDataset(outputPath):
    dataset = os.path.join(PROJECT_PATH, "generated", "ShapeNet", "ShapeNetv2_ellipsoid_100_features_autoencoder")
    category = "02691156"
...
def main():
    ...
    outputName = "pairs_airplane_ellipsoid_FPS100_exact_oct_autoencoder"
